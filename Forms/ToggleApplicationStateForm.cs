...
namespace TriangleAuto.Forms
{
    public partial class ToggleApplicationStateForm : Form, IObserver
    {
        ...
        public ToggleApplicationStateForm(Subject subject)
        {
            ...
            // Set tray icon text to application name from config
        ...
        private bool toggleStatus()
        {
            ...
            if (isOn)
            {
                ...
                this.notifyIconTray.Icon = Resources.TriangleAuto.ETCResource.logoTriangleAuto_off;
                this.subject.Notify(new Utils.Message(MessageCode.TURN_OFF, null));
                this.lblStatusToggle.Text = "Press the key to start!";
                new SoundPlayer(Resources.TriangleAuto.ETCResource.Speech_Off).Play();
            }
            else
            {
                ...
                if (client != null)
                {
                    ...
                    this.notifyIconTray.Icon = Resources.TriangleAuto.ETCResource.logoTriangleAuto_on;
                    ...
                    new SoundPlayer(Resources.TriangleAuto.ETCResource.Speech_On).Play();
                } else
                {
